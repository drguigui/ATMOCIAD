...
#	errorbar(datacrs,dataenergy,yerr=datauncert,label=leg)
	...
	posicent=0
	menels=300
	if(dataenergy[-1]>menels):
		while(dataenergy[posicent]<menels):
			dataenergy+=1
	
	
	

	testcrs=intbetheoppenheimer(dataenergy[posicent:],datacrs[posicent:],teste)
	...
	#plot(teste,BetheOp(array([1E-14,1E-1]),array(teste)))
	#plot(teste,BetheOp(array([1E-14,1E-2]),array(teste)))
	#plot(teste,BetheOp(array([1E-14,1E-3]),array(teste)))
	#plot(teste,BetheOp(array([1E-14,1E-4]),array(teste)))
	#plot(teste,BetheOp(array([1E-15,1E-1]),array(teste)))
	#plot(teste,BetheOp(array([1E-15,1E-2]),array(teste)))
	#plot(teste,BetheOp(array([1E-15,1E-3]),array(teste)))
	#plot(teste,BetheOp(array([1E-15,1E-4]),array(teste)))
