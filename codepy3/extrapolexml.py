...
The extrapolation of each cross-section uses a power law function to create the extrapolation. See the documentation for powerlaw.py for details on the extrapolation function.
