...
\nomenclature{AMOP}{Photoionization cross sections database compiled by the AMOP group. The name has now changed into PHIDRATES and is located at \url{http://phidrates.space.swri.edu/}.}
